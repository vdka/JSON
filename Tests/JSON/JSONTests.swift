...
//  
//  func assertThrow(error: JSON.Parser.Error, json: String, line: UInt = #line) {
//    do {
//      try JSON.Parser.parse(json)
//      XCTFail("Expected error, got success", line: line)
//    } catch let err as JSON.Parser.Error {
//      XCTAssertEqual(err, <#T##expression2: [T : U]##[T : U]#>)
...
//  }
//  
//  func assertThrow(error: JSON.Serializer.Error, json: String, line: UInt = #line) {
//    do {
//      try JSON.Parser.parse(json)
//      XCTFail("Expected error, got success", line: line)
//    } catch let err as JSON.Serializer.Error {
//      XCTAssertEqual(err, error, line: line)
//    } catch {
//      XCTFail(line: line)
//    }
...
//    
//    assertNoThrow {
//      try JSON.Parser.parse("{\"name\":\"Harry\"}")
//    }
//    
//    assertNoThrow {
//      try JSON.Parser.parse("{\"name\":\"Harry\"}")
...
//    
//    assertNoThrow { 
//      try JSON.Parser.parse("{\n  \n}")
//    }
//    
//    assertNoThrow { 
//      try JSON.Parser.parse("{\"function\":null,\"numbers\":[4,8,15,16,23,42],\"y_index\":2,\"x_index\":12,\"z_index\":5,\"arcs\":[{\"p2\":[22.1,50],\"p1\":[10.5,15.5],\"radius\":5},{\"p2\":[23.1,40],\"p1\":[11.5,15.5],\"radius\":10},{\"p2\":[23.1,30],\"p1\":[12.5,15.5],\"radius\":3},{\"p2\":[24.1,20],\"p1\":[13.5,15.5],\"radius\":2},{\"p2\":[25.1,10],\"p1\":[14.5,15.5],\"radius\":8},{\"p2\":[26.1,0],\"p1\":[15.5,15.5],\"radius\":2}],\"label\":\"my label\"}")
//    }
//    
////    assertNoThrow { 
...
//    
//    XCTAssertEqual(try JSON.Parser.parse("[1, 2, null, 4, null, 6]"), [1, 2, 4, 6] as JSON)
//    
//  }
//  
//  func testSanity() {
...
//    let flatHeteroGeniousArray: JSON = .array([0, "1", "two", 3.00001, true, false, JSON.null, [4, "five", false] as JSON])
//    XCTAssertEqual(flatHeteroGeniousArray, flatHeteroGeniousArray)
//  }
//  
