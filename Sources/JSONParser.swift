...
extension JSON.Parser {
  ...
  */
  mutating func parseValue() throws -> JSON {
    ...
    switch peek() {
    // TODO: Current slowness seems to be due to the values in cases being initialized. They should be static.
    case objectOpen:
  ...
  mutating func parseArray() throws -> JSON {
    ...
    var tempArray: [JSON] = []
    tempArray.reserveCapacity(6) // TODO: Performance test this.
  ...
  mutating func parseString() throws -> String {
    ...
    repeat {
      // TODO: Check to see if memcpy is viable
      let char = try pop()
  ...
  // TODO: stop using temp buffer, this costs a copy every time. Would be [nice|fast] to pass [strtoll|strtod] `pointer` and have it work.
